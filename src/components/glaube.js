      ...
      content: (
        <div>
          <p className="mb-2">
            ...
            <a className="underline" href="https://www.moea.gov.tw/Mns/populace/news/News.aspx?kind=1&menu_id=40&news_id=94687">
              經濟部已協調各類賣場管制人流
              <ExtLinkIcon />
            </a>
            ，維持社交距離：
      ...
      text: (
        ...
        <div className="flex flex-col">
          ...
          <span className="pt-4">
            ...
            Google 有提供 Google Analytics 選擇退出附加元件 (Google Analytics Opt-out Browser Add-on) 下載，
            請瀏覽以下網址：
...
// EXPORT 匯出
export {
  uriComponents, landingPageComponents,
