    ...
    aboutOSM: [
        {
            ...
            description: [
                ...
                { segment: (<div>OSM 的圖資允許所有人使用及編輯，全球的地圖資料庫會定期進行備份，使用者也可以直接下載這份圖資並在開放的規範下使用。OSM 採用<a href="https://wiki.osmfoundation.org/wiki/Licence/Licence_and_Legal_FAQ" className="text-fern-green-600" aria-label="" target="_blank" rel="noopener noreferrer">《開放資料庫授權》（ODbL）< ExtLinkIcon /></a><span className="text-grey-600 text-sm mx-1">(英語)</span>方式授權釋出，沒有版權費用、許可證費用、使用費用及其他一切費用， 您可以將圖資用於個人、社群、教育、商業、政府以及其他任何可以想到的應用用途。</div>) },
...
// Contact page components 隠私權政策頁面構成
        ...
        },
        {
            ...
            text: (
                <div className="flex flex-col">
                    <span>本網站使用 Google Analytics  以收集有關使用者的資訊，透過分析使用者與之互動來進一步改善網站，這當中可能包括使用者概略的位置資訊。
                    有關本站如何使用 Google Analytics 的更多資訊，請瀏覽以下網址：<a className="text-fern-green-600" href="https://www.google.com/analytics/terms/us.html" target="_blank" rel="noopener noreferrer">https://www.google.com/analytics/terms/us.html</a>。</span>
                    <span className="pt-4">
                        若您不希望被 Google Analytics 追蹤，Google 有提供 Google Analytics 選擇退出附加元件 (Google Analytics Opt-out Browser Add-on) 下載，請瀏覽以下網址：<a className="text-fern-green-600" href="https://tools.google.com/dlpage/gaoptout?hl=zh-tw" target="_blank" rel="noopener noreferrer">https://tools.google.com/dlpage/gaoptout?hl=zh-tw</a>。
                    </span>
                </div>
            ),
        },
...
//EXPORT 匯出
export {
    ExtLinkIcon, OsmtwGuideTitle, commonComponents, landingPageComponents, aboutPageComponents, contactPageComponents, privacyPageComponents, tosPageComponents
}