        ...
        <div className="relative w-full flex py-32 md:py-64 bg-cover bg-center bg-no-repeat object-fill bg-osmtw-landing-hero osmtw-osmcontributors--bottom-right">
          <div className="w-full md:w-11/12 lg:w-full xl:w-3/4 mx-auto p-2">
            <div className="flex-1 text-center md:text-left bg-slate-100 bg-opacity-25 mx-auto px-4 my-4 md:px-16 md:mr-8 lg:ml-16">
              <div className="text-4xl md:text-6xl lg:text-7xl font-semibold text-slate-900 leading-none my-4 ">開放街圖・台灣</div>
              ...
              <button type="button" className="my-2 px-6 py-2 md:my-4 md:px-8 md:py-4 rounded-full font-semibold tracking-wide bg-pink-500 text-white outline-none focus:outline-none hover:shadow-lg hover:bg-pink-600 transition duration-200 ease-in-out">
                立刻開始使用
              </button>
            </div>
          </div>
          ...
          <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            <div className="flex flex-col mb-6 lg:flex-row md:mb-10">
              <div className="w-full mb-16 lg:w-1/2">
                <h2 className="max-w-full text-3xl lg:text-4xl xl:text-5xl font-bold highlight-yellow text-slate-900 xl:max-w-lg">人人可編輯的世界地圖</h2>
              </div>
              <div className="w-full lg:w-1/2">
                <h3 className="text-base text-slate-700 md:text-lg">OpenStreetMap（開放街圖，簡稱 OSM）是自由而且開源的全球地圖，於 2004 年由英國的 Steve Coast 發起，採用類似 Wiki 的協作編輯以及開放的授權與格式。OSM 的地圖由像你一樣的使用者繪製。因為來自一般的使用者，所以內容相當多元。資料的來源可能根據手持 GPS 裝置、航照圖以及其他自由內容，甚至是單靠使用者由於對本地的認識而得。雖然不全是經過專業訓練的人士，但可以產生接近專業地理資訊水準的地圖。 地圖以開放資料庫授權（ODbL）方式授權，可以日常生活、導航、學術、甚至商業應用。</h3>
              </div>
            </div>
            <div className="flex mt-6 justify-center mb-16">
              <div className="w-24 h-1 rounded-full bg-teal-500 inline-flex" />
            </div>
        ...
        <div className="relative w-full flex flex-col-reverse bg-teal-300 py-16 lg:p-0 lg:flex-col">
          ...
          <div className="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl">
            <div className="lg:my-40 lg:max-w-xl">
              ...
              <h2 className="px-1 mb-5 font-sans text-5xl font-medium tracking-tight text-slate-900 md:px-0.5 md:text-6xl sm:leading-none md:leading-snug space-y-2">
              ...
              <div className="flex items-center mb-8">
                ...
                <Link
                  href="/qsg/mapper/"
                  className="inline-flex items-center font-semibold text-slate-800 transition-colors duration-200 hover:text-blue-600"
                >
                  {learnMore}
                </Link>
              </div>
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            ...
            <div className="flex flex-col justify-center px-5 -mx-4 md:px-0 lg:pl-8 lg:max-w-lg xl:max-w-3xl">
              ...
              <div className="max-w-xl mb-6">
                <h2 className="max-w-lg mb-6 text-3xl sm:text-4xl font-bold tracking-tight text-slate-900 sm:leading-none">
                  不同圖磚 各取所需
                </h2>
                ...
                <blockquote className="py-4 md:py-8 space-y-1 text-xs text-slate-500 flex flex-col">
                  <div>&copy; OpenStreetMap contributors.</div>
                  <div>Humanitarian Map Tiles style by Humanitarian OpenStreetMap Team.</div>
                  <div>Transport Map Tiles courtesy of Andy Allan.</div>
                </blockquote>
          ...
          <section className="text-slate-600 body-font">
            <div className="container px-5 py-16 mx-auto">
              <div className="flex flex-col text-center w-full mb-20">
                ...
                <h1 className="sm:text-4xl text-3xl font-medium title-font text-slate-900">發掘開放街圖的更多潛在的可能性</h1>
              </div>
                    ...
                    <div className="flex rounded-lg h-full shadow-lg bg-slate-100 p-8 flex-col">
                      <div className="flex items-center mb-3">
                        <div className="w-12 h-12 mr-3 inline-flex items-center justify-center rounded-full bg-green-500 text-white flex-shrink-0">
                          <svg className="p-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
                            <path d={link.SVGpath} />
                          </svg>
                        </div>
                        <h2 className="text-slate-900 text-xl title-font font-medium">
                          我是
                          {link.role}
                        </h2>
                      </div>
                      <div className="flex-grow">
                        ...
                        >
                          {learnMore}
                          <svg className="w-4 h-4 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3">
          ...
          <div className="w-full md:w-3/4 xl:w-3/5 2xl:w-2/3 2xl:max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
            ...
            <div className="mt-8 flex lg:mt-0 lg:flex-shrink-0">
              <div className="inline-flex rounded-md shadow">
                <a href="https://osm.org/" className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-indigo-600 hover:bg-indigo-700">
                  開始畫圖
                  <ExtLinkIcon />
                </a>
              </div>
              <div className="ml-3 inline-flex rounded-md shadow">
                <Link href="/qsg" className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-lg text-indigo-600 bg-white hover:bg-indigo-50">
                  {learnMore}
                </Link>
              </div>
            </div>
