          ...
          <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            <div className="flex flex-col mb-6 lg:flex-row md:mb-10">
              <div className="w-full mb-16 lg:w-1/2">
                <h2 className="max-w-full text-3xl lg:text-4xl xl:text-5xl font-bold highlight-yellow text-slate-900 xl:max-w-lg">
                  人人可編輯的世界地圖
                </h2>
              </div>
              <div className="w-full lg:w-1/2">
                <h3 className="text-base text-slate-700 md:text-lg">
            ...
            <div className="grid gap-8 row-gap-10 sm:grid-cols-2 lg:grid-cols-4">
              {landingPageComponents.feature.map((link) => (
                <div className="max-w-md" key={link.id}>
                  ...
                  <p className="mb-3 text-sm md:text-base gray-900">
                    {link.desc}
                  </p>
                </div>
              ))}
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            ...
            <div className="flex flex-col justify-center px-5 -mx-4 md:px-0 lg:pl-8 lg:max-w-lg xl:max-w-3xl">
              ...
              <div className="max-w-xl mb-6">
                ...
                <a
                  className="inline-flex items-center font-semibold text-green-600"
          ...
          <section className="text-slate-600 body-font">
            <div className="container px-5 py-16 mx-auto">
              <div className="flex flex-col text-center w-full mb-20">
                <h2 className="text-2xl text-green-500 tracking-widest font-semibold title-font mb-1">
                  &#35;當地圖不再只是地圖
                </h2>
                <h1 className="sm:text-4xl text-3xl font-medium title-font text-slate-900">
                  發掘開放街圖的更多潛在的可能性
                </h1>
              </div>
