          ...
          <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            <div className="flex flex-col mb-6 lg:flex-row md:mb-10">
              ...
              <div className="w-full lg:w-1/2">
                <h3 className="text-base tracking-wide leading-7 text-slate-700 dark:text-white md:text-lg">
                  OpenStreetMap（開放街圖，簡稱
                  OSM）是自由而且開源的全球地圖，於 2004 年由英國的 Steve Coast
                  發起，採用類似 Wiki 的協作編輯以及開放的授權與格式。OSM
                  的地圖由像你一樣的使用者繪製。因為來自一般的使用者，所以內容相當多元。資料的來源可能根據手持
                  GPS
                  裝置、航照圖以及其他自由內容，甚至是單靠使用者由於對本地的認識而得。雖然不全是經過專業訓練的人士，但可以產生接近專業地理資訊水準的地圖。
                  地圖以開放資料庫授權（ODbL）方式授權，可以日常生活、導航、學術、甚至商業應用。
                </h3>
              </div>
            </div>
            <div className="flex my-12 justify-center md:mt-6 md:mb-16">
              ...
              {landingPageComponents.feature.map((link) => (
                <React.Fragment key={link.id}>
                  <div className="max-w-md">
                    <div className="flex items-center justify-center relative mx-auto w-32 h-32 md:w-24 md:h-24 mb-4 rounded-full bg-red-200">
                      <svg
                        className="w-24 h-24 md:w-16 md:h-16 text-red-500"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        strokeLinecap="round"
                    ...
                    <h6 className="mb-2 font-semibold text-center md:text-lg leading-5">
                      {link.heading}
                    </h6>
                    <p className="mb-3 text-sm tracking-wide md:text-base gray-900">
                      {link.desc}
                    </p>
                  </div>
                </React.Fragment>
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            ...
            <div className="flex flex-col justify-center px-5 -mx-4 md:px-0 lg:pl-8 lg:max-w-lg xl:max-w-3xl">
              ...
              <div className="max-w-xl mb-6">
                <h2 className="max-w-lg mb-6 text-3xl sm:text-4xl font-bold tracking-tight text-slate-900 dark:text-white sm:leading-none">
                  不同圖磚 各取所需
                </h2>
                <div className="text-base mb-2 md:text-lg text-slate-700 dark:text-white">
                  OpenStreetMap及其他應用服務有提供多種地圖樣式，即使是相同的資料也會給你帶來截然不同的感受！
                </div>
                <a
                  className="inline-flex items-center font-semibold text-green-600 dark:text-green-200"
        ...
        <div className="relative w-full flex-1 text-left max-w-7xl">
          <div className="container p-5 md:py-16 mx-auto text-slate-600 body-font">
            <div className="flex flex-col text-center w-full mb-12 md:mb-20">
              <h2 className="text-2xl text-green-500 dark:text-green-200 tracking-widest font-semibold title-font mb-1">
                &#35;當地圖不再只是地圖
              </h2>
              <h1 className="sm:text-4xl text-3xl font-medium title-font text-slate-900 dark:text-white">
                發掘開放街圖的更多潛在的可能性
              </h1>
            </div>
