        ...
        <div className="md:w-2/3 mx-auto">
          ...
          <div className="my-8 md:my-16 space-y-3">
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div class="max-w-3xl mx-auto rounded-lg overflow-hidden shadow-lg my-2 bg-white dark:bg-grey-600">
                <a href="https://coscup.org/2021/zh-TW/landing" target="_blank" rel="noopener noreferrer">
                  ...
                  <div class="px-6 py-4 space-y-3">
                    {/* 標籤 Hashtag here */}
                    <span class="inline-block rounded-full px-3 py-1 text-sm font-semibold bg-fern-green-50 mr-2">#COSCUP</span>
                    <span class="inline-block rounded-full px-3 py-1 text-sm font-semibold bg-fern-green-50 mr-2">#全亞洲最熱情</span>
                    <span class="inline-block rounded-full px-3 py-1 text-sm font-semibold bg-fern-green-50 mr-2">#志工主辦</span>
                    <span class="inline-block rounded-full px-3 py-1 text-sm font-semibold bg-fern-green-50 mr-2">#活力滿點</span>
                  </div>
                </a>
              </div>
