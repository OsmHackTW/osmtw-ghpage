  ...
  return (
    <Layout title="開發者">
      ...
      <div>
        ...
        <p className="my-1">
          OpenStreetMap 圖資是開放資料。OSM
          的許可證允許任何人、隨時隨地複製再利用，我們
          <span className="font-bold">「永遠」</span>
          不會就此向使用者收取任何費用。 您可以前往了解更多可能性：
          <a
        ...
        <p className="my-1">最常用的圖磚服務供應商有：</p>
        <p className="my-1">
          <ul className="list-disc list-inside ml-1">
            ...
            <li>
              <a href="https://www.klokantech.com/">Klokan Technologies</a>
              <ExtLinkIcon />
              <EnIcon />
              亦有提供免費方案給予非商業行為使用，詳情請瀏覧：
              <a href="https://www.openmaptiles.org/">openmaptiles.org</a>
              <ExtLinkIcon />
            </li>
            <li>
              自架圖磚服務，詳情請瀏覧：
