...
import mth_mtg from "../assets/images/mth_mtg.jpg";
      ...
      <section className="antialiased text-gray-900 py-2 h-full flex items-center justify-center">
        <div className="container mx-auto">
          <div className="max-w-xl lg:max-w-4xl mx-auto my-6 bg-white md:rounded-lg shadow-sm overflow-hidden">
            <img className="object-cover bg-center w-full h-64" src={mth_mtg} alt="月聚 Monthly gathering" />
            <div className="p-4 md:px-12 md:py-6">
              ...
              <h3 class="text-gray-600 dark:text-gray-400">您可透過以下渠道與社群交流： </h3>
              <h3 class="text-gray-600 dark:text-gray-400">Contact our community
                members via the following channels:</h3>
              <div class="pt-4 pb-12 space-y-3">
                {contactPageComponents.communityButton.map((button) => (
                  <a href={button.href} aria-label="" target="_blank" rel="noopener noreferrer"
                    class={'inline-block px-4 py-2 mr-3 text-xs font-medium leading-6 text-center text-white transition rounded-full shadow ripple focus:outline-none bg-' + button.colorBg + '-700 hover:bg-' + button.colorBg + '-800'}
                  >
                    {button.title}
                  </a>
                ))}
                ...
                <form action="https://formspree.io/f/mzbkygdb" method="POST" id="form">
                  ...
                  <div className="mb-6">
                    <label for="message" >
                      ...
                      <textarea type="text" id="msg" name="message" rows="8"
                        maxlength="256" placeholder="您的留言 Your Message" className="w-full px-3 py-2 placeholder-gray-300 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-indigo-100 focus:border-indigo-300 dark:bg-gray-700 dark:text-white dark:placeholder-gray-500 dark:border-gray-600 dark:focus:ring-gray-900 dark:focus:border-gray-500" required></textarea>
                    </label>
                  </div>
                  <div className="mb-6">
              ...
              <div className="mb-6">
                ...
                <h5 className="text-sm text-gray-500">OSMTW community members will get back to you as soon as available once received. Thanks!
                </h5>
              </div>
            </div>
          </div>
