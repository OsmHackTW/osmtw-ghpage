    ...
    <section className="antialiased text-slate-900 py-2 h-full flex items-center justify-center dark:text-slate-200">
      <div className="w-full xl:w-8/12 2mx-auto px-4 sm:px-8  pb-16">
        <div className="main-title my-8 md:my-16">
          ...
          <h1 className="font-bold text-slate-500 text-lg md:text-3xl lg:text-4xl text-center my-4 dark:text-slate-200">
            Privacy Statement
          </h1>
          <h2 className="font-bold text-slate-400 text-center my-4 dark:text-slate-200">
        ...
        <div className="bg-white shadow overflow-hidden sm:rounded-lg dark:bg-slate-800 ">
          <div className="px-4 py-5 sm:px-6">
            <h3 className="flex flex-col text-lg md:text-xl leading-6 font-medium text-slate-900 dark:text-slate-200">
              <span className="py-1">
                我們非常重視您的個人隱私，在使用本網站服務時，敬請詳閲本隱私權聲明，
              </span>
              <span className="py-1">
                了解我們如何蒐集、處理及運用您所提供的個人資料，以及如何保護你的資料安全：
              </span>
            </h3>
            <h5 className="mt-1 max-w-2xl text-sm text-slate-500 dark:text-slate-200">
              Your privacy is our highest priority, please refer our privacy
              policy for more details on how we collect, process and protect
